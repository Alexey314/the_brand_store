<template>
  <div class="cart-product cart-view__product" >
    <img src="img/cart_products/2.jpg" alt="product image" class="cart-product__img">
    <div class="cart-product__details">
      <svg v-on:click="removeItem" class="cart-product__details-btn-del" width="18" height="18"
...
export default {
  ...
  computed: {
    getItemData() {
      // console.log('cartItem.getItemData');
      return this.$store.getters.getCartItemData(this.$vnode.key);
    }
  },
}
</script>
